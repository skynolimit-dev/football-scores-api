...
function initUserPreferencesWatcher(globals, setMatchesOfInterestForUser) {
    console.log('Watching user preferences collection for changes');
    ...
    userPreferencesWatcher = query.onSnapshot(querySnapshot => {
        querySnapshot.docChanges().forEach(change => {
            ...
            console.log(`Updated preferences for device ID: ${deviceId}, Preferences: ${JSON.stringify(preferences)}`);

            // TODO: Update user preferences cache
